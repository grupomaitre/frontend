...
const DataMain: FC<Props> = ({ tabId, validation, listCartegorias, subRubrosOptions }) => {
            ...
            <TabPane tabId={tabId} id="home" className=' ' style={{ fontSize: '0.7rem' }}>
                ...
                <Row className='mb-1'>
                    ...
                    <Col lg='3'>
                        ...
                        <SelectGeneric
                            optionSelect={(e: number) => validation.setFieldValue('id_sub_rubro', e)}
